  ...
  render() {
    ...
    return (
      <form className="form__inputs">
        <Input labelText="Full name" id="name" autoComplete="name" handleChange={handleChange}/>
        ...
        <Input type="url" labelText="Personal website" id="website" handleChange={handleChange}/>
